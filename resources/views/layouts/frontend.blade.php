...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-custom shadow-sm py-3 fixed-top">
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}"><b>Wildan Store</b></a>
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        @if (isset(auth()->user()->name))
                            <a class="nav-link active bg-primary text-white" href="{{ url('profile') }}">
                                {{ auth()->user()->name }} <i class="fas fa-user"></i>
                            </a>
                        @else
                            <a class="nav-link active" href="{{ url('masuk') }}">Login</a>
                        @endif
                    </li>
