            ...
            <div class="col-md-5">
                <div class="card card-rounded">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title pt-2">{{ __('Daftar Akun Pembeli') }}</h5>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form method="POST" action="{{ route('prosesdaftarakun') }}">
                            @csrf
                            ...
                            <hr>
                            <a class="btn btn-link d-block text-center" href="{{ route('masuk') }}">
